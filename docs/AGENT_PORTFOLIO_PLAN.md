...
状态：已完成。阶段性能、成功/拒绝 trace 与完整回归见 [`baselines/2026-08-25-agent-tool-layer.md`](baselines/2026-08-25-agent-tool-layer.md)。
...
详细 provider、凭据、工具循环、SSE、报告与会话兼容设计见 [`AGENT_PHASE_2_PLAN.md`](AGENT_PHASE_2_PLAN.md)。P2-00 已确认，P2-01/P2-02 provider 层已完成；真实模型调用和首次真实 userdata 会话写入仍需分别确认。
