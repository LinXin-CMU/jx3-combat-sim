...
pub static BUFF_DUN_FEI_DEF: BuffDef = BuffDef {
    ...
    effects: &[], activate_recipes: &[], haste_scaled: false,
};
...
pub static BUFF_XUE_NU_DEF: BuffDef = BuffDef {
    ...
    effects: EFFECTS_XUE_NU, activate_recipes: &[], haste_scaled: false,
};
...
pub static BUFF_XU_RUO_DEF: BuffDef = BuffDef {
    ...
    effects: EFFECTS_XU_RUO, activate_recipes: &[], haste_scaled: false,
};
...
pub static BUFF_LIU_XUE_DEF: BuffDef = BuffDef {
    ...
    effects: &[], activate_recipes: &[], haste_scaled: true,
};
...
pub static BUFF_ZHAN_JUE_DEF: BuffDef = BuffDef {
    ...
    effects: EFFECTS_ZHAN_JUE, activate_recipes: &[], haste_scaled: false,
};
...
pub static BUFF_HAN_XIAO_DEF: BuffDef = BuffDef {
    ...
    effects: EFFECTS_HAN_XIAO, activate_recipes: &[], haste_scaled: false,
};
...
pub static BUFF_ZHEN_FEN_DEF: BuffDef = BuffDef {
    ...
    effects: EFFECTS_ZHEN_FEN, activate_recipes: &[], haste_scaled: false,
};
...
pub static BUFF_MIE_SHI_DEF: BuffDef = BuffDef {
    ...
    effects: EFFECTS_MIE_SHI, activate_recipes: &[], haste_scaled: false,
};
...
pub static BUFF_HAN_JIA_SMALL_DEF: BuffDef = BuffDef {
    ...
    effects: EFFECTS_HAN_JIA_SMALL, activate_recipes: &[], haste_scaled: false,
};
...
pub static BUFF_HAN_JIA_LARGE_DEF: BuffDef = BuffDef {
    ...
    duration_frames: 192, tick_interval: 0, max_stacks: 125, is_debuff: false,
    show_on_timeline: false, timeline_order: 0, short_name: None,
    effects: EFFECTS_HAN_JIA_LARGE, activate_recipes: &[], haste_scaled: false,
};
...
pub static BUFF_JIAN_TIE_DEF: BuffDef = BuffDef {
    ...
    effects: EFFECTS_JIAN_TIE, activate_recipes: &[], haste_scaled: false,
};
...
pub static BUFF_JI_ANG_DEF: BuffDef = BuffDef {
    ...
    effects: EFFECTS_JI_ANG, activate_recipes: &[], haste_scaled: false,
};
...
static EFFECTS_YAN_ZHEN: &[EffectEntry] = &[
...
pub static BUFF_YAN_ZHEN_DEF: BuffDef = BuffDef {
    ...
    show_on_timeline: true, timeline_order: 33, short_name: Some("严阵"),
    effects: EFFECTS_YAN_ZHEN, activate_recipes: &[], haste_scaled: false,
};
...
pub static BUFF_TIE_GU_DEF: BuffDef = BuffDef {
    ...
    effects: EFFECTS_TIE_GU, activate_recipes: &[], haste_scaled: false,
};
...
pub static BUFF_TIE_GU_SU_DI_DEF: BuffDef = BuffDef {
    ...
    effects: EFFECTS_TIE_GU_SU_DI, activate_recipes: &[], haste_scaled: false,
};
