...
pub const AGENT_PROMPT_VERSION: &str = "agent-system/v29";
const AGENT_SYSTEM_PROMPT: &str = include_str!("../../prompts/agent_system_v29.md");
...
mod tests {
    ...
    fn current_prompt_is_single_model_led_instruction() {
        ...
        assert_eq!(prompt.version, "agent-system/v29");
